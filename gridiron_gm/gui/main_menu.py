...
import os
import json
from gridiron_gm.engine.core.save_game_manager import (
...
from gridiron_gm.engine.draft.player_generator import PlayerGenerator  # ✅ NEW import

BASE_DIR = os.path.dirname(os.path.abspath(__file__))

TEAM_LIST = [
    "Chicago Cyclones", "Dallas Outlaws", "Miami Tritons", "New York Empire",
    "San Francisco Surge", "Nashville Blues", "Las Vegas Vipers", "Atlanta Firebirds",
    "Boston Minutemen", "Houston Stampede", "Los Angeles Paladins", "Philadelphia Liberty",
    "Phoenix Inferno", "Detroit Mechanics", "Seattle Eclipse", "Denver Peaks",
