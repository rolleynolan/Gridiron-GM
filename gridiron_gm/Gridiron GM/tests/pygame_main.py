...
from simulation.entities.league import load_league_from_file, LeagueManager
from simulation.systems.game.offseason_manager import OffseasonManager
from simulation.systems.core.team_data import load_teams_from_json
from datetime import timedelta, date
from simulation.entities.player import Player  # adjust import as needed
from simulation.utils.college_player_generator import generate_freshman_class
from simulation.utils.draft_class_generator import generate_draft_class
from simulation.systems.game.draft_manager import DraftManager
from simulation.systems.roster.transacion_manager import TransactionManager
...
try:
    ...
    teams = load_teams_from_json("config/teams.json")
    positions = (
        ["QB"] * 3 +
        ["RB"] * 4 +
        ["WR"] * 6 +
