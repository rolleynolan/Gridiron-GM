...
from simulation.utils.calendar import Calendar  # Update if calendar is moved elsewhere
from simulation.systems.game.season_manager import SeasonManager  # Update if season_manager is moved elsewhere
...
def load_league_from_file(save_name):
    ...
    try:
        ...
        from simulation.systems.game.season_manager import fill_team_rosters_with_dummy_players
