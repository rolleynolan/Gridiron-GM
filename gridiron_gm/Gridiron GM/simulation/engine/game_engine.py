...
from simulation.systems.roster.depth_chart import generate_depth_chart
from config.formations import FORMATION_SCHEMES
from simulation.systems.player.fatigue import FatigueSystem
from simulation.engine.stat_utils import merge_player_stats, get_top_performers
...
def simulate_pass_play(qb: Any, wr_list: List[Any], depth: str, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from simulation.systems.player.injury_manager import create_injury
...
def sim_drive(offense, defense, sub_mgr, fatigue_log, context, start_field_pos=25):
    ...
    """
    from simulation.engine.penalty_engine import simulate_play as simulate_penalty_play
    ...
    from simulation.systems.roster.substitution_manager import SubstitutionManagerV2
