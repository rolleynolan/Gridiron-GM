...
import json
import sys
from simulation.systems.game.standings_manager import StandingsManager, update_team_records
import simulation.engine.game_engine as game_engine
from simulation.systems.player.fatigue import accumulate_season_fatigue_for_team
from simulation.engine.game_engine import simulate_game

# NEW: Import from team_data
from simulation.systems.core.team_data import load_teams_from_json, fill_team_rosters_with_dummy_players

from simulation.systems.core.data_loader import (
    load_schedule_files, save_results, save_league_state, save_playoff_bracket, save_playoff_results
)
from simulation.systems.core.serialization_utils import league_to_dict
from simulation.utils.generate_schedule import add_nfl_style_playoff_schedule
